...
New-ADDCCloneConfigFile -Static -IPv4Address 192.168.1.253 -IPv4DefaultGateway 192.168.1.254 -IPv4DNSResolver 192.168.1.1 -IPv4SubnetMask 255.255.255.0 -CloneComputerName DC03
