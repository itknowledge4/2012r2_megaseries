...
Get-ClusterSharedVolume "Cluster Disk 2" | Suspend-ClusterResource -Force
Get-ClusterResource "Cluster Disk 3" | Suspend-ClusterResource -Force
...
Get-ClusterResource "Cluster Disk 3" | Resume-ClusterResource
